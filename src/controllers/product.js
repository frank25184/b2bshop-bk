...
module.exports = {
        ...
        try {
            ...
            form.parse(req, async (err, fields, files) => {
                ...
                try {
                    ...
                    const updateData = {
                        name,
                        name_changed: util.urlBeautify(name),
                        pathName: util.urlBeautify(util.trim(xss(fields.pathName ? fields.pathName[0] : ''))),
                        content,
                    ...
                    res.redirect(`/product/${updatedProduct.pathName}`);
    ...
    form.parse(req,(err,fields,files)=>{
       ...
       let name = util.trim(xss(fields.name ? fields.name[0] : '')),
        ...
        product.pathName = util.urlBeautify(seoTitle);
