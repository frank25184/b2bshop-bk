...
// ObjectId
// Array
var proSubcategorySchema = new Schema({
...
proSubcategorySchema.methods.time = time=> {
    return moment(time).format('MMMM D, YYYY');
};

proSubcategorySchema.methods.processCategory = ca=>{
    let intro = ca.intro;
    if(intro){
...
module.exports = mongoose.model('ProSubcategory', proSubcategorySchema);