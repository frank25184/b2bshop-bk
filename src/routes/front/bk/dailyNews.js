...
const express = require('express'),
      ...
      news = require('../../controllers/dailyNews'),
...
router.get('/:tertiaryPath',crawlerFilter,visitTracker, news.showOne);//start with a limit of around 10-30 requests per minute per IP addres
