...
const express = require('express'),
      ...
      prompt = require('../../controllers/prompt'),
      visitTracker = require('../../middlewares/visitTracker');
     // limit = require('../../libs/limit');
   //   auth = require('../../middlewares/auth');


router.get('/:tertiaryPath', visitTracker, prompt.showSite);//start with a limit of around 10-30 requests per minute per IP addres
